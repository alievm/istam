...
const Girls = () => {
    ...
    useEffect(() => {
        ...
        const fetchClothingItems = async () => {
            try {
                const boys = await getAllClothing({subCategoryId: "67644f083e7fad60d6684307"});
    ...
    return (
        <div>
            <div className="relative h-[400px] bg-cover bg-center"
                 style={{backgroundImage: "url('/high-angle-view-young-children.jpg')"}}>
            ...
            <div className="grid grid-cols-1  sm:grid-cols-5  mx-auto gap-4 px-4" ref={ref3}>
                {boysClothing.map((item, index) => (
                    <motion.div key={item.id}
                                className="p-4 rounded-lg mx-auto max-w-[337px] relative"
                                initial="hidden"
